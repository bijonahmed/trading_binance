                            ...
                            <div class="border p-4 rounded">
                                <form @submit.prevent="saveData()" id="formrest" class="forms-sample"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"  disabled readonly  class="form-control name" v-model="insertdata.email"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" disabled readonly class="form-control phone" v-model="insertdata.username"
...
const checkRow = () => {
    ...
    axios.get(`/user/getUserRow/${id}`).then(response => {
        ...
        insertdata.username = response.data.data.username;
