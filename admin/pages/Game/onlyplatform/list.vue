        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <p>Only Platform List ({{ totalRecords }})</p>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/game/onlyplatform/add">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/games/onlyPltformList`, {
            params: {
                page: page,
                pageSize: pageSize,
